...
public class Admin_View_Tickets extends Base {
...
//    private DocumentReference documentReference = db.collection("Bookings").document(UUID);
    ...
    public void onStop() {
        super.onStop();
        Log.d(TAG, "Admin_View_Tickets :: onStop ");
    ...
    protected void onStart() {
        super.onStart();
        Log.d(TAG, "Admin_View_Tickets :: onStart ");
        adapter.startListening();
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin__view__tickets);
